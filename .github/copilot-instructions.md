...
- **Authoritative path**: `/home/ssf/Documents/Github/cliplot` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/cliplot.git`, branch `main`.
...
3. This repo, in order: `BUSINESS.md` `SYSTEM.md` `AGENTS.md` `TASKS.md`
