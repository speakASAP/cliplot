...
assert(packet.readyForBoundedWindow === true, 'bounded-window metadata/token readiness missing', packet);
...
assert(packet.metadataApprovals?.window === true, 'smoke window metadata missing', packet);
