...
console.log(JSON.stringify({
  ...
  productSelectionMode: report.catalog.productScopeEvidence.selectionMode,
  approvedCliplotSkuScope: report.catalog.productScopeEvidence.approvedCliplotSkuScope,
