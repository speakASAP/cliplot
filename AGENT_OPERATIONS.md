...
No repository-defined add operations derived from approved cliplot requirements
...
## Project-Specific Operations
Respect the existing Czech e-commerce storefront runtime and use only its tracked operational interfaces.
