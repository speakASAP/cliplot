...
| `GOAL-03-shared-service-integration` | active | Catalog, guarded checkout submit, service identity, Vault projection, notifications/auth boundaries wired safely. |
