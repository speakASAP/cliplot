...
| `GOAL-05-checkout-revenue-readiness` | active | GOAL-03/04 plus owner/provider evidence | Provider-backed checkout evidence; current lane has authenticated Catalog reads plus no-mutation payment and no-send notification validation. |
