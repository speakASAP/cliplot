...
| `GOAL-03-shared-service-integration` | active | GOAL-02 | Catalog/auth reads, guarded checkout submit, service identity, Vault projection, and shared-service blockers recorded. |
