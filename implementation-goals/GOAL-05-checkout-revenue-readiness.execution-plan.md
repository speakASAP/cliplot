...
| Payment S2S identity lane (SPOT Bearer) | done | payments/platform lane | Auth-issued `(cliplot -> payments)` RS256 JWT via Vault/K8s | invalid-body smoke returned 400 VALIDATION_ERROR |
